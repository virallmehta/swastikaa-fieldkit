...
interface SNFS_Context_Interface {
     ...
     *
     * Examples:
     *   SNFS_Post_Context    → returns the post type slug  ('post', 'page', 'product', …)
     *   SNFS_Term_Context    → returns the taxonomy slug   ('category', 'post_tag', 'genre', …)
     *   SNFS_User_Context    → returns 'user'
     *   SNFS_Options_Context → returns the options page slug ('general', 'my-theme-settings', …)
     */
    public function get_type(): string;

    /**
     * The storage driver that knows how to read/write values for this context.
     * SNFS_Field_Base calls this — it never hard-codes get_post_meta() etc.
     */
